...
export const TRANSLATIONS: Record<string, TranslationItem> = {
  ...
  widget_gender: { en: "I am a", hi: "मैं हूँ", ma: "मैं छी" },
  widget_look: { en: "Looking for a", hi: "वर/वधू खोज", ma: "वर/वधू खोज" },
  widget_gotra: { en: "Of Gotra", hi: "गोत्र", ma: "गोत्र" },
  widget_submit: { en: "Let's Match", hi: "अनुकूल मिलान खोजें", ma: "अनुकूल मिलान खोजू" },
  ...
  landing_why_desc: { en: "Preserving legacy through verified cultural lineage, secure gotra rules, and trusted connections.", hi: "विश्वसनीय गोत्र मिलान और समृद्ध सांस्कृतिक परंपराओं के माध्यम से परिवारों को जोड़ना।", ma: "विश्वसनीय गोत्र मिलान आ समृद्ध सांस्कृतिक परंपराओं के माध्यम से परिवारों को जोड़ना।" },
  landing_why_item1_title: { en: "🧬 Gotra Compatibility Safeguards", hi: "🧬 गोत्र मिलान सुरक्षा", ma: "🧬 गोत्र मिलान सुरक्षा" },
  landing_why_item1_desc: { en: "Automated filters screen matches based on traditional gotra customs to align with lineage values.", hi: "हमारी प्रणाली पारंपरिक गोत्र नियमों के अनुसार अनुकूल मिलान स्वतः और सुरक्षित रूप से खोजती है।", ma: "हमारी प्रणाली पारंपरिक गोत्र नियमों के अनुसार अनुकूल मिलान स्वतः आ सुरक्षित रूप से खोजती अछि।" },
  landing_why_item2_title: { en: "🔒 Secure Contact Verification", hi: "🔒 सुरक्षित संपर्क सत्यापन", ma: "🔒 सुरक्षित संपर्क सत्यापन" },
  landing_why_item2_desc: { en: "Off-line simulated OTP authentication prevents unverified profiles and secures contact databases.", hi: "ओटीपी सत्यापन द्वारा सुरक्षित प्रोफाइल पंजीकरण ताकि केवल विश्वसनीय और सत्यापित लोग ही जुड़ सकें।", ma: "ओटीपी सत्यापन द्वारा सुरक्षित प्रोफाइल पंजीकरण ताकि केवल विश्वसनीय आ सत्यापित लोग ही जुड़ सकें।" },

  // Landing "What We Offer" Localizations
  landing_what_title: { en: "What We Offer", hi: "क्या है हमारी सेवा?", ma: "की अछि हमारी सेवा?" },
  landing_what_desc: { en: "A modern visual experience designed to make matrimonial search delightful, interactive, and fast.", hi: "आपके जीवनसाथी की खोज को बेहद सरल, सुंदर, मनोरंजक और आधुनिक बनाने के लिए नवीन सुविधाएं।", ma: "आपके जीवनसाथी की खोज को बेहद सरल, सुंदर, मनोरंजक आ आधुनिक बनाने के लिए नवीन सुविधाएं।" },
  ...
  landing_what_item1_desc: { en: "Every candidate is vetted with simulated contact authentication to eliminate spam and ensure authentic credentials.", hi: "स्पैम को रोकने और वास्तविक पहचान सुनिश्चित करने के लिए हर उम्मीदवार को सत्यापित किया जाता है।", ma: "स्पैम को रोकने आ वास्तविक पहचान सुनिश्चित करने के लिए हर उम्मीदवार को सत्यापित किया जाइत अछि।" },
  landing_what_item2_title: { en: "⚡ Modern Matching Algorithms", hi: "⚡ आधुनिक गोत्र और फिल्टर मिलान", ma: "⚡ आधुनिक गोत्र आ फिल्टर मिलान" },
  landing_what_item2_desc: { en: "Intelligent Gotra-compatibility rules matched with age, income, and lifestyle filters to guide you to the right partner.", hi: "पारंपरिक गोत्र नियमों के साथ उम्र, आय और जीवनशैली प्राथमिकताओं पर आधारित तीव्र एवं सटीक मिलान तकनीक।", ma: "पारंपरिक गोत्र नियमों के साथ उम्र, आय आ जीवनशैली प्राथमिकताओं पर आधारित तीव्र एवं सटीक मिलान तकनीक।" },
  ...
  landing_who_title: { en: "Who We Are", hi: "कौन हैं हम?", ma: "कौन छथि हम?" },
  landing_who_desc: { en: "Bridging legacy roots and progressive hearts to connect Maithil families globally.", hi: "मैथिल परिवारों को वैश्विक स्तर पर जोड़ने के लिए समर्पित एक आधुनिक और सुरक्षित साझा मंच।", ma: "मैथिल परिवारों को वैश्विक स्तर पर जोड़ने के लिए समर्पित एक आधुनिक आ सुरक्षित साझा मंच।" },
  ...
  btn_request_otp: { en: "Request Verification OTP", hi: "ओटीपी कोड का अनुरोध करें", ma: "ओटीपी कोड का अनुरोध करू" },
  btn_verify_otp: { en: "Verify & Authenticate", hi: "सत्यापित करें", ma: "सत्यापित करू" },
  btn_change_phone: { en: "Change Mobile Number", hi: "मोबाइल नंबर बदलें", ma: "मोबाइल नंबर बदलें" },
  error_invalid_phone: { en: "Invalid mobile number. Must be in E.164 format.", hi: "अमान्य मोबाइल नंबर। E.164 प्रारूप में होना चाहिए।", ma: "अमान्य मोबाइल नंबर। E.164 प्रारूप में हेबाक चाही।" },
  ...
  bot_welcome: { 
    ...
    hi: "नमस्ते! मैथिल मैच में स्वागत है। चलिए एक संवादात्मक बातचीत के माध्यम से आपका बायोडाटा बनाते हैं। सबसे पहले, आपका पूरा नाम क्या है?", ma: "नमस्ते! मैथिल मैच में स्वागत अछि। चलिए एक संवादात्मक बातचीत के माध्यम से आपका बायोडाटा बनाते छथि। सबसे पहले, आपका पूरा नाम की अछि?" 
  },
  bot_gender: { 
    en: "Pleasure to meet you, {name}! Please select your gender.", 
    hi: "आपसे मिलकर खुशी हुई, {name}! कृपया अपना लिंग चुनें।", ma: "आपसे मिलकर खुशी हुई, {name}! कृपया अपन लिंग चुनें।" 
  },
  bot_age: { 
    en: "Great. Now, how old are you? (Must be 18 to 70 years)", 
    hi: "बहुत बढ़िया। अब, आपकी उम्र क्या है? (उम्र 18 से 70 वर्ष के बीच होनी चाहिए)", ma: "बहुत बढ़िया। अब, आपकी उम्र की अछि? (उम्र 18 से 70 वर्ष के बीच हेबाक चाही)" 
  },
  bot_height: { en: "What is your height? (e.g. 5'8\")", hi: "आपकी लंबाई क्या है? (जैसे 5'8\")", ma: "आपकी लंबाई की अछि? (जैसे 5'8\")" },
  bot_marital: { en: "What is your marital status?", hi: "आपकी वैवाहिक स्थिति क्या है?", ma: "आपकी वैवाहिक स्थिति की अछि?" },
  bot_complexion: { en: "What is your complexion?", hi: "आपका रंग-रूप (complexion) क्या है?", ma: "आपका रंग-रूप (complexion) की अछि?" },
  bot_gotra: { 
    en: "Important question! What is your cultural Gotra?", 
    hi: "महत्वपूर्ण प्रश्न! आपका सांस्कृतिक गोत्र क्या है?", ma: "महत्वपूर्ण प्रश्न! आपका सांस्कृतिक गोत्र की अछि?" 
  },
  bot_diet: { en: "What are your dietary preferences?", hi: "आपका खान-पान (Diet) कैसा है?", ma: "आपका खान-पान (Diet) कैसा अछि?" },
  bot_city: { 
    en: "Got it. In which city do you currently reside?", 
    hi: "समझ गए। आप वर्तमान में किस शहर में रह रहे हैं?", ma: "समझ गेल। अहाँ वर्तमान में किस शहर में रह रहे छथि?" 
  },
  bot_education: { 
    en: "Excellent. What is your highest educational qualification?", 
    hi: "उत्कृष्ट। आपकी उच्चतम शैक्षणिक योग्यता क्या है?", ma: "उत्कृष्ट। आपकी उच्चतम शैक्षणिक योग्यता की अछि?" 
  },
  bot_profession: { 
    en: "What is your current occupation or profession?", 
    hi: "आपका वर्तमान पेशा या व्यवसाय क्या है?", ma: "आपका वर्तमान पेशा या व्यवसाय की अछि?" 
  },
  bot_income: { 
    en: "Thank you. What is your annual income (INR)?", 
    hi: "धन्यवाद। आपकी वार्षिक आय (INR) क्या है?", ma: "धन्यवाद। आपकी वार्षिक आय (INR) की अछि?" 
  },
  bot_interests: { 
    en: "Almost there! Select your hobbies and interests (choose at least one).", 
    hi: "बस कुछ ही कदम और! अपनी रुचियों और शौक का चयन करें (कम से कम एक चुनें)।", ma: "बस कुछ ही कदम आ! अपन रुचियों आ शौक का चयन करू (कम से कम एक चुनें)।" 
  },
  bot_bio: { 
    en: "Write a brief, warm 'About Me' description.", 
    hi: "अपने बारे में संक्षेप में एक प्यारा सा परिचय लिखें।", ma: "अपन बारे में संक्षेप में एक प्यारा सा परिचय लिखें।" 
  },
  bot_photo: {
    en: "Perfect! Finally, please upload a nice profile photo so compatible matches can see your warm smile.",
    hi: "बहुत बढ़िया! अंत में, कृपया एक सुंदर प्रोफाइल फ़ोटो अपलोड करें ताकि अनुकूल मिलान आपका मुस्कुराता हुआ चेहरा देख सकें।", ma: "बहुत बढ़िया! अंत में, कृपया एक सुंदर प्रोफाइल फ़ोटो अपलोड करू ताकि अनुकूल मिलान आपका मुस्कुराता हुआ चेहरा देख सकें।"
  },
  bot_summary: { 
    en: "Excellent! I have compiled your Maithil Biodata. Please review the summary card below.", 
    hi: "अद्भुत! मैंने आपका मैथिल बायोडाटा तैयार कर लिया है। कृपया नीचे दिए गए सारांश कार्ड की समीक्षा करें।", ma: "अद्भुत! मैंने आपका मैथिल बायोडाटा तैयार कर लिया अछि। कृपया नीचे दिए गेल सारांश कार्ड की समीक्षा करू।" 
  },

  // Chat validations & buttons
  chat_placeholder: { en: "Type your reply here...", hi: "अपना उत्तर यहाँ लिखें...", ma: "अपन उत्तर ईाँ लिखें..." },
  chat_btn_send: { en: "Send", hi: "भेजें", ma: "भेजू" },
  chat_error_empty: { en: "Please provide a valid text input.", hi: "कृपया एक वैध उत्तर दर्ज करें।", ma: "कृपया एक वैध उत्तर दर्ज करू।" },
  chat_error_age: { en: "Age must be a number between 18 and 70.", hi: "उम्र 18 और 70 के बीच एक संख्या होनी चाहिए।", ma: "उम्र 18 आ 70 के बीच एक संख्या हेबाक चाही।" },
  chat_error_income: { en: "Annual income must be a valid positive number.", hi: "वार्षिक आय एक वैध सकारात्मक संख्या होनी चाहिए।", ma: "वार्षिक आय एक वैध सकारात्मक संख्या हेबाक चाही।" },
  ...
  btn_confirm_submit: { en: "Confirm & Register Profile", hi: "पुष्टि करें और प्रोफाइल दर्ज करें", ma: "पुष्टि करू आ प्रोफाइल दर्ज करू" },

  // Browse Dashboard
  browse_title: { en: "Discover Compatible Matches", hi: "अनुकूल जीवनसाथी खोजें", ma: "अनुकूल जीवनसाथी खोजू" },
  browse_subtitle: { en: "Profiles are evaluated based on gotra compatibility, location filters, and age preferences.", hi: "गोत्र मिलान, स्थान और आयु प्राथमिकताओं के आधार पर प्रोफाइल का मूल्यांकन किया जाता है।", ma: "गोत्र मिलान, स्थान आ आयु प्राथमिकताओं के आधार पर प्रोफाइल का मूल्यांकन किया जाइत अछि।" },
  browse_alert: { en: "Automatically calculated opposite gender matches with compatible Gotras", hi: "गोत्र मिलान के अनुसार अनुकूल विपरीत लिंग प्रोफाइल स्वतः प्रदर्शित हैं", ma: "गोत्र मिलान के अनुसार अनुकूल विपरीत लिंग प्रोफाइल स्वतः प्रदर्शित छथि" },
  card_match: { en: "Match", hi: "मैच", ma: "मैच" },
  btn_request_connect: { en: "Request Match Connect", hi: "कनेक्ट अनुरोध भेजें", ma: "कनेक्ट अनुरोध भेजू" },
  no_matches: { en: "No compatible profiles found matching your compatibility criteria. Try modifying your preferences!", hi: "आपकी प्राथमिकताओं से मेल खाती हुई कोई प्रोफाइल नहीं मिली। कृपया अपनी प्राथमिकताओं को बदलें!", ma: "आपकी प्राथमिकताओं से मेल खाती हुई कोई प्रोफाइल नहीं मिली। कृपया अपन प्राथमिकताओं को बदलें!" },

  // Phase 3: Profile Discovery & Freemium
  nav_browse: { en: "Browse", hi: "खोजें", ma: "खोजू" },
  ...
  filter_apply: { en: "Apply Filters", hi: "फ़िल्टर लागू करें", ma: "फ़िल्टर लागू करू" },
  
  action_interest: { en: "Send Interest", hi: "रुचि भेजें", ma: "रुचि भेजू" },
  action_shortlist: { en: "Shortlist", hi: "शॉर्टलिस्ट", ma: "शॉर्टलिस्ट" },
  action_pass: { en: "Pass", hi: "छोड़ें", ma: "छोड़ें" },
  action_chat: { en: "Chat", hi: "चैट करें", ma: "चैट करू" },
  
  premium_title: { en: "Premium Feature", hi: "प्रीमियम फ़ीचर", ma: "प्रीमियम फ़ीचर" },
  premium_desc: { en: "Upgrade your plan to view contact details.", hi: "संपर्क विवरण देखने के लिए अपना प्लान अपग्रेड करें।", ma: "संपर्क विवरण देखने के लिए अपन प्लान अपग्रेड करू।" },
  premium_btn: { en: "Upgrade Now", hi: "अभी अपग्रेड करें", ma: "अभी अपग्रेड करू" },
  ...
  chat_summary_btn: { en: "Looks Good! View Matches", hi: "ठीक है! मिलान देखें", ma: "ठीक अछि! मिलान देखू" }
};
